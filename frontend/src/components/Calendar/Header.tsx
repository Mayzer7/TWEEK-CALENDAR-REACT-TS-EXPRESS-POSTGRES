    ...
    <div className="header">
      <div className="header-content">
        ...
        <div className="header-right-side">
          <button className="someday-btn" onClick={onSomedayClick} type="button">
            Когда-нибудь
          </button>
          ...
          <button className="search-btn" onClick={onSearchClick} type="button">
            <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="navigation-buttons">
            <button className="left-btn" onClick={onPrev} type="button">
            ...
            <button className="right-btn" onClick={onNext} type="button">
              <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
